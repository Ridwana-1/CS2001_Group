...
-- CreateIndex
CREATE INDEX "UnreadMessage_channelId_idx" ON "UnreadMessage"("channelId");
...
-- AddForeignKey
ALTER TABLE "UnreadMessage" ADD CONSTRAINT "UnreadMessage_channelId_fkey" FOREIGN KEY ("channelId") REFERENCES "Channel"("id") ON DELETE CASCADE ON UPDATE CASCADE;
